...
<div class="row flex-nowrap">
    ...
    <div class="bg-dark p-2">
            <a href="#" class="d-flex text-decoration-none mt-1 align-items-center text-white">
                <span class="fs-4 d-none d-sm-inline ms-3"></span>
            </a>
            <ul class="nav nav-pills flex-column mt-4">
                <li class="nav-item py-2 py-sm-0">
                    <a href="farmerDashboard.php?page=viewFarmerDeliveries" class="nav-link text-white">
                        <span class="fs-4 d-sm-inline">Deliveries</span>
                    </a>
                </li>
                <li class="nav-item py-2 py-sm-0">
                    <a href="farmerDashboard.php?page=view-payments" class="nav-link text-white">
